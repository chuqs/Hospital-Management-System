 ...
 * @author EFE ROBERT
 */
public class AuditScan extends javax.swing.JFrame {

    /**
     * Creates new form AuditScan
     */
    public AuditScan() {
        initComponents();
        CurrentDate();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("AUDIT (SCAN & SIGN APPROVER)");
        ...
        setSize(new java.awt.Dimension(868, 612));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AuditScan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
