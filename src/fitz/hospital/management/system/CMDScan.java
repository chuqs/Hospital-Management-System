 ...
 * @author EFE ROBERT
 */
public class CMDScan extends javax.swing.JFrame {

    /**
     * Creates new form CMDScan
     */
    public CMDScan() {
        initComponents();
        CurrentDate();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("CMD (SCAN & SIGN APPROVER)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CMDScan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
