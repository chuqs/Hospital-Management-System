 ...
 * @author EFE ROBERT
 */
public class AdministrationScan extends javax.swing.JFrame {

    /**
     * Creates new form AdministrationScan
     */
    public AdministrationScan() {
        initComponents();
        CurrentDate();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("ADMINISTRATION (SCAN & SIGN APPROVER)");
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 850, 570));
        ...
        setSize(new java.awt.Dimension(866, 615));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdministrationScan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdministrationScan().setVisible(true);
            }
        });
    }
