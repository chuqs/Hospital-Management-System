 ...
 * @author EFE ROBERT
 */
public class AccountScan extends javax.swing.JFrame {

    /**
     * Creates new form AccountScan
     */
    public AccountScan() {
        initComponents();
        CurrentDate();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("ACCOUNT (SCAN & SIGN APPROVER)");
        ...
        setSize(new java.awt.Dimension(872, 614));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AccountScan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AccountScan().setVisible(true);
            }
        });
    }
